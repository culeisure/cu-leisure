...
const POSTS = [
  { slug: 'post-cassia-sokcho-membership', title: '카시아 속초 오너스 멤버십, 바다 앞 객실을 회원권으로 갖는 새로운 방식', cat: '분양 전략', date: '2026.08.25', read: '7분', img: '../assets/images/posts/post-cassia-sokcho-membership/post-cassia-sokcho-membership_cover.webp', desc: '반얀그룹이 운영하는 속초 대포항의 카시아 속초. 연 30박 또는 20박, 3,000만 원대부터, 15년 시점 환매청구권. 리조트 회원권 시장에서 이 구조가 갖는 의미.' },
  { slug: 'post-suseo-weekday-membership', title: '군위수서 주중이용권, 골프와 콘도와 파크골프를 한 장에 담은 상품의 계산법', cat: '분양 전략', date: '2026.08.11', read: '6분', img: '../assets/images/posts/post-suseo-weekday-membership/post-suseo-weekday-membership_cover.webp', desc: '대구 45분 거리 군위수서골프앤리조트의 주중이용권 3종. 주중 그린피 6만 원, 콘도 연 2~4박, 파크골프까지 한 상품에 담은 구조가 올해 시장과 맞아떨어지는 이유.' },
  { slug: 'post-2026-h1-review', title: '2026년 상반기 골프 시장 점검, 내장객은 돌아왔지만 치는 방식이 달라졌다', cat: '골프 산업', date: '2026.07.28', read: '7분', img: '../assets/images/posts/post-2026-h1-review/post-2026-h1-review_cover.webp', desc: '상반기 내장객 10% 증가, 그러나 객단가는 하락. 2~3인 예약 25% 증가, 야간 라운드 두 배, 숙박 포함 골프여행 36% 증가. 숫자보다 소비 방식의 변화를 읽는다.' },
  { slug: 'post-membership-acquisition-tax', title: '회원제 골프장 취득세 4%에서 12%, 멈춘 M&A와 대중제 결합 모델의 부상', cat: '골프 산업', date: '2026.07.14', read: '7분', img: '../assets/images/posts/post-membership-acquisition-tax/post-membership-acquisition-tax_cover.webp', desc: '2026년부터 회원제 골프장은 사고팔 때도 취득세 12% 중과. 잭니클라우스GC 사례로 보면 취득세가 120억에서 360억으로 뛴다. 회원제의 출구가 막힌 자리에 들어서는 모델.' },
  ...
  { slug: 'post-membership-polarization', title: '회원권 평균가 2억 5천만 원, 사상 최고가의 이면에 있는 두 개의 시장', cat: '골프 산업', date: '2026.06.12', read: '7분', img: '../assets/images/posts/post-membership-polarization/post-membership-polarization_cover.webp', desc: '골프회원권 평균가가 2007년 고점을 넘었다. 그러나 오른 것은 5억 원 이상 초고가 구간뿐. 회원제 골프장이 29%로 줄어든 구조에서 둘로 갈라진 회원권 시장을 읽는다.' },
