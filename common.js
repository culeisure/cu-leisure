...
const POSTS = [
  { slug: 'post-cassia-sokcho-membership', title: '카시아 속초 오너스 멤버십, 바다 앞 객실을 회원권으로 갖는 새로운 방식', cat: '분양 전략', date: '2026.08.25', read: '7분', img: '../assets/images/posts/post-cassia-sokcho-membership/post-cassia-sokcho-membership_cover.webp', desc: '반얀그룹이 운영하는 속초 카시아의 오너스 멤버십. 연 30박 또는 20박, 3,000만 원대부터, 15년 시점 환매청구권의 의미를 짚는다.' },
  { slug: 'post-suseo-weekday-membership', title: '군위수서 주중이용권, 골프와 콘도를 한 장에 담은 상품의 계산법', cat: '분양 전략', date: '2026.08.11', read: '6분', img: '../assets/images/posts/post-suseo-weekday-membership/post-suseo-weekday-membership_cover.webp', desc: '대구 45분 군위수서골프앤리조트의 주중이용권 3종. 주중 그린피 6만 원과 콘도 연 2~4박을 묶은 구조가 올해 시장과 맞는 이유.' },
  { slug: 'post-2026-h1-review', title: '2026년 상반기 골프 시장 점검, 내장객은 돌아왔지만 치는 방식이 달라졌다', cat: '골프 산업', date: '2026.07.28', read: '7분', img: '../assets/images/posts/post-2026-h1-review/post-2026-h1-review_cover.webp', desc: '상반기 내장객 10% 증가에도 객단가는 하락. 2~3인 예약, 야간 라운드, 숙박 결합 골프여행 증가가 말하는 소비 방식의 변화.' },
  { slug: 'post-membership-acquisition-tax', title: '회원제 골프장 취득세 4%에서 12%, 멈춘 M&A와 대중제 결합 모델의 부상', cat: '골프 산업', date: '2026.07.14', read: '7분', img: '../assets/images/posts/post-membership-acquisition-tax/post-membership-acquisition-tax_cover.webp', desc: '2026년부터 회원제 골프장은 사고팔 때도 취득세 12% 중과. 멈춘 M&A와 대중제 골프장에 숙박을 묶는 모델이 대안으로 선 이유.' },
  { slug: 'post-parkgolf-industry', title: '23만 명에서 멈춘 파크골프, 다음 성장은 민간에서 나온다', cat: '골프 산업', date: '2026.06.24', read: '7분', img: '../assets/images/posts/post-parkgolf-industry/post-parkgolf-industry_cover.webp', desc: '파크골프 협회 회원 5년 새 5배, 그러나 2026년 상반기 23만 명에서 정체. 무료 공공 구장 모델의 한계와 민간 회원모집 시장의 가능성.' },
  { slug: 'post-membership-polarization', title: '회원권 평균가 2억 5천만 원, 사상 최고가의 이면에 있는 두 개의 시장', cat: '골프 산업', date: '2026.06.12', read: '7분', img: '../assets/images/posts/post-membership-polarization/post-membership-polarization_cover.webp', desc: '골프회원권 평균가 2억 5천만 원으로 19년 만의 최고치. 그러나 오른 것은 초고가 구간뿐이다. 둘로 갈라진 회원권 시장을 읽는다.' },
