...
const POSTS = [
  ...
  { slug: 'post-suseo-weekday-membership', title: '군위수서 주중이용권, 골프와 콘도를 한 장에 담은 상품의 계산법', cat: '분양 전략', date: '2026.08.11', read: '6분', img: '../assets/images/posts/post-suseo-weekday-membership/post-suseo-weekday-membership_cover.webp', desc: '대구 45분 거리 군위수서골프앤리조트의 주중이용권 3종. 주중 그린피 6만 원, 콘도 연 2~4박을 한 상품에 담은 구조가 올해 시장과 맞아떨어지는 이유.' },
